...
//    $.cookie('name', 'value', { path: '/' });
    ...
    $("#score-table > tbody").append("<tr id='highscore' style='color:green;'><th><h4>Record</h4></th><th><h4>"+timeDisplay+"</h4></th><th><h4>"+scoreDisplay+"</h4></th></tr>");
...
//        console.log("new");
        ...
        setTimeout(function () {
            ...
            $('#highscore').html("<th><h4>Record</h4></th><th><h4>"+totalTime+"</h4></th><th><h4>"+totalScore+"</h4></th>");
        }, 2000);
    }
}